...
const MainLayout: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    // SUPER_ADMIN / ADMINISTRATION can access all tabs
  ...
  // If logged in as STUDENT, render the dedicated Think Garden Portal Estudante screen
  if (currentUser.role === 'STUDENT') {
    return (
  ...
  // If logged in as TEACHER, render the dedicated Think Garden Painel do Professor screen
  if (currentUser.role === 'TEACHER') {
    return (
      <div className="min-h-screen bg-[#f8f9fa] text-slate-800 font-sans antialiased selection:bg-[#075e38] selection:text-white">
