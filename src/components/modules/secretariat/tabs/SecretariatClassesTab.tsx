...
export const SecretariatClassesTab: React.FC = () => {
  ...
  const handleOpenEdit = (cls: ClassRoom) => {
    ...
    setEditClassForm({
      ...
      teacherName: cls.teacherName || 'Sem professor vinculado',
      schedule: cls.schedule || '',
      room: cls.room || '',
      maxCapacity: cls.maxCapacity || 25,
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div>
                ...
                <input
                  ...
                  min={5}
                  max={60}
                  value={newClassForm.maxCapacity ?? 25}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-3">
              <div>
                ...
                <input
                  ...
                  min={5}
                  max={60}
                  value={editClassForm.maxCapacity ?? 25}
              ...
              <div>
                ...
                <select
                  value={editClassForm.status || 'ACTIVE'}
